...
// player.
public class ThreePlayerGameCursorAdapter extends CursorAdapter {

    // Constructs a new Two PlayerGameCursorAdapter
    public ThreePlayerGameCursorAdapter(Context context, Cursor cursor) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.list_item_three_players, parent,
                false);
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.list_item_three_players,
                    null, false);
        }
